...
private[spark] object BlockManagerMessages {
  ...
  case class GetFAREvictionFeedback(blockId: BlockId) extends ToBlockManagerMaster

  case class GetFARGenerationFeedback(blockId: BlockId) extends ToBlockManagerMaster
}
