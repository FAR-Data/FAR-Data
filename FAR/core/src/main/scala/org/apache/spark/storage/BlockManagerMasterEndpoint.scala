...
class BlockManagerMasterEndpoint(
  ...
  override def receiveAndReply(context: RpcCallContext): PartialFunction[Any, Unit] = {
    ...
    case GetFAREvictionFeedback(blockId) =>
      context.reply(getFeedbackAfterEviction(blockId))

    case GetFARGenerationFeedback(blockId) =>
      context.reply(getFeedbackAfterGeneration(blockId))
  ...
  // Implemented by FAR
  private def getFeedbackAfterEviction(blockId: BlockId): Boolean = {
    FARManager.get.handleBlockEviction(blockId: BlockId)
  }

  // Implemented by FAR
  private def getFeedbackAfterGeneration(blockId: BlockId): Boolean = {
    FARManager.get.handleBlockGeneration(blockId: BlockId)
  }
