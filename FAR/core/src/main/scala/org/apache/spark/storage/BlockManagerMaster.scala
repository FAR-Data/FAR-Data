...
class BlockManagerMaster(
  ...
  /** Implemented by FAR */
  def getFARFeedbackAfterEviction(blockId: BlockId): Unit = {
    driverEndpoint.ask[Boolean](GetFAREvictionFeedback(blockId))
  }

  /** Implemented by FAR */
  def getFARFeedbackAfterPuttingIntoMemory(blockId: BlockId): Unit = {
    driverEndpoint.ask[Boolean](GetFARGenerationFeedback(blockId))
  }
   ...
   * implemented by FAR.
   */
  def removeBlockAsync(blockId: BlockId): Unit = {
    driverEndpoint.ask[Boolean](RemoveBlock(blockId))
  }
